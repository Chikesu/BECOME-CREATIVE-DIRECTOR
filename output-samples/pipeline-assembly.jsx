// ============================================
// AI VIDEO PIPELINE — After Effects Assembly Script
...
//    📂 project/
//    ├── 📂 shot/     ← shot_1.mp4, shot_2.mp4...
//    ├── 📂 voice/    ← voiceover.mp3 (or .wav)
//    ├── 📂 music/    ← music.mp3 (or .wav)
//    └── 📂 assets/   ← logo.png, etc.
//
// 2. Open After Effects
// 3. File → Scripts → Run Script File → select this .jsx
...
(function(){
  ...
  // --- SUMMARY ---
  var summary = "✅ Pipeline Assembly Complete!\n\n";
  ...
  summary += "• " + Math.min(shotFiles.length, NUM_SHOTS) + " video shots (with cross dissolves)\n";
  summary += "• " + (voFiles.length > 0 ? "1" : "0") + " voice-over track\n";
  summary += "• " + (muFiles.length > 0 ? "1" : "0") + " music track (ducked -12dB)\n";
  summary += "• Text overlays on applicable shots\n";
  summary += "• " + (logoFiles.length > 0 ? "1 logo watermark" : "No logo found") + "\n\n";
